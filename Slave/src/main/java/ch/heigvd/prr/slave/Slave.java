...
/**
 * The Slave class is the Slave application main class which purpose is to
 * provide a clock that approximately synchronize itself to a Master application
 ...
 * other application to query the synchronized time. Both are run in seperate
 * threads.
 */
public class Slave {
