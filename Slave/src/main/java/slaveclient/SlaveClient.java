...
/**
 * This class implements a client TCP interface that other applications can use
 * to ask the Slave application for the synchronized time.
 *
 * This class opens a TCP socket on port 14000 on which other applications can
 * request time by sending a simple byte of value 1 (GET_TIME).
 *
 ...
 * measured in milliseconds, between the current time and midnight, January 1,
 * 1970 UTC, with some added offset and delay, due to the synchronization with
